...
import com.pfe.project.payload.response.JwtResponse;
import com.pfe.project.repository.RoleRepository;
import com.pfe.project.repository.UserRepository;
import com.pfe.project.security.services.UserDetailsImpl;
	...
	public ResponseEntity<?> registerUser(@Valid @RequestBody SignupRequest signUpRequest) {
		...
		if (strRoles == null) {
			...
			strRoles.forEach(role -> {
				switch (role) {
				case "marketing":
					Role adminRole = roleRepository.findByName(ERole.ROLE_MARKETING)
							.orElseThrow(() -> new RuntimeException("Error: Role is not found."));
					roles.add(adminRole);
